...
dem_plot <- tm_shape(dem)+
  tm_raster(style = "cont", palette = "PuOr", legend.show = TRUE)+
  tm_scale_bar()

dem_plot |> tmap_save(filename=dem_plot_interactive_fp)
dem_plot |> tmap_save(filename=dem_plot_static_fp)
```

::: {#fig-dem-plot .captioned-figure}
<img src="./images/dem-plot.png" alt="DEM plot" width="1000">

Screenshot of DEM plot. View the **[interactive map here](./images/dem-plot.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
hillshade_plot_interactive_fp <- "./images/hillshade-plot.html"
hillshade_plot_static_fp <- "./images/hillshade-plot.png"
...
hillshade_plot <- tm_shape(hillshade)+
  tm_raster(style = "cont",palette = "-Greys", legend.show = FALSE)+
  tm_scale_bar()

hillshade_plot |> tmap_save(filename=hillshade_plot_interactive_fp)
hillshade_plot |> tmap_save(filename=hillshade_plot_static_fp)
```

::: {#fig-hillshade-plot .captioned-figure}
<img src="./images/hillshade-plot.png" alt="Hillshade plot" width="1000">

Screenshot of hillshade plot. View the **[interactive map here](./images/hillshade-plot.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
pour_points_plot_interactive_fp <- "./images/pour_points_plot.html"
pour_points_plot_static_fp <- "./images/pour_points_plot.png"
...
pour_points_plot <- tm_shape(streams)+
  tm_raster(legend.show = TRUE, palette = "Blues")+
tm_shape(pp)+
  tm_dots(col = "red")

pour_points_plot |> tmap_save(filename=pour_points_plot_interactive_fp)
pour_points_plot |> tmap_save(filename=pour_points_plot_static_fp)
```

::: {#fig-pour-points-plot .captioned-figure}
<img src="./images/pour_points_plot.png" alt="Hillshade plot" width="1000">

Screenshot of pour points plot. View the **[interactive map here](./images/pour_points_plot.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
watershed_plot_interactive_fp <- "./images/watershed_plot.html"
watershed_plot_static_fp <- "./images/watershed_plot.png"
...
watershed_plot <- tm_shape(hillshade)+
  tm_raster(style = "cont",palette = "-Greys", legend.show = FALSE)+
tm_shape(ws)+
...
watershed_plot |> tmap_save(filename=watershed_plot_interactive_fp)
watershed_plot |> tmap_save(filename=watershed_plot_static_fp)
```

::: {#fig-watershed-plot .captioned-figure}
<img src="./images/watershed_plot.png" alt="Watershed plot" width="1000">

Screenshot of watershed plot. View the **[interactive map here](./images/watershed_plot.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
watershed_shp_plot_interactive_fp <- "./images/watershed_shp_plot.html"
watershed_shp_plot_static_fp <- "./images/watershed_shp_plot.png"

wsshape <- st_as_stars(ws) %>% st_as_sf(merge = T)

ws1shp <- wsshape %>% filter(brush_watersheds.tif == "1")

watershed_shp_plot <- tm_shape(hillshade)+
  tm_raster(style = "cont",palette = "-Greys", legend.show = FALSE)+
tm_shape(ws1shp)+
  tm_borders(col = "red")

watershed_shp_plot |> tmap_save(filename=watershed_shp_plot_interactive_fp)
watershed_shp_plot |> tmap_save(filename=watershed_shp_plot_static_fp)
```

::: {#fig-watershed-shp-plot .captioned-figure}
<img src="./images/watershed_shp_plot.png" alt="Watershed shapefile plot" width="1000">

Screenshot of watershed shapefile plot. View the **[interactive map here](./images/watershed_shp_plot.html)**. 
:::
...
```{r}
watershed_3d_plot_interactive_fp <- "./images/watershed_3d_plot.html"
watershed_3d_plot_static_fp <- "./images/watershed_3d_plot.png"
...
rgl_plot |> htmlwidgets::saveWidget(watershed_3d_plot_interactive_fp)
rgl::snapshot3d(filename = watershed_3d_plot_static_fp, scene = rgl_plot)
```

::: {#fig-watershed-3d-plot .captioned-figure}
<img src="./images/watershed_3d_plot.png" alt="Watershed 3d plot" width="1000">

Screenshot of 3D watershed plot. View the **[interactive map here](./images/watershed_3d_plot.html)**. 
:::
